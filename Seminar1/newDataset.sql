INSERT INTO course_layout (course_code, course_name, min_students, max_students, hp, layout_version) VALUES
...
INSERT INTO max_course_instance (max_instance) VALUES
(3), (2), (4), (1), (2);


INSERT INTO employee (employment_id, person_id, job_title_id, department_id, max_course_instance_id) VALUES
('EMP001', 1, 1, 1, 3),
('EMP002', 2, 1, 2, 2),
('EMP003', 3, 2, 1, 4),
('EMP004', 4, 3, 1, 1),
...
INSERT INTO salary_history (employee_id, monthly_salary, salary_version) VALUES
(1, '52000', 1),
(2, '48000', 1),
(3, '39000', 1),
(4, '32000', 1),
...
INSERT INTO course_instance (instance_id, study_period, study_year, course_layout_id, num_students) VALUES
('CS101-2025-P1', 'P1', '2025-01-01', 1, '85'),
('CS201-2025-P2', 'P2', '2025-01-01', 2, '60'),
('MA101-2025-P1', 'P1', '2025-01-01', 3, '110');
...
INSERT INTO allocation (employee_id, planned_activity, course_instance_id) VALUES
(1, 'Intro Lecture', 1),
(1, 'Programming Lab A', 1),
(2, 'Data Structures Lecture', 2),
(3, 'Programming Lab A', 1),
(5, 'Calculus Seminar', 3);
